...
const ul = {
  label: new N3.NamedNode(_apg.ns.label),
  key: new N3.NamedNode(_apg.ns.key),
  value: new N3.NamedNode(_apg.ns.value),
  reference: new N3.NamedNode(_apg.ns.reference),
  unit: new N3.NamedNode(_apg.ns.unit),
  iri: new N3.NamedNode(_apg.ns.iri),
  literal: new N3.NamedNode(_apg.ns.literal),
  datatype: new N3.NamedNode(_apg.ns.datatype),
  product: new N3.NamedNode(_apg.ns.product),
  component: new N3.NamedNode(_apg.ns.component),
  coproduct: new N3.NamedNode(_apg.ns.coproduct),
  option: new N3.NamedNode(_apg.ns.option),
  source: new N3.NamedNode(_apg.ns.source)
};
